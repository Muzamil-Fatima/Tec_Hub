...
const CourseCard = ({ course }) => {
  ...
  return (
    <div className=" bg-white p-6 flex flex-col space-y-4  rounded-2xl hover:shadow-2xl shadow-gray-300 wrap-break-word w-full transform transition duration-200 hover:scale-105">
      <img
        src={course.images[0]}
        alt={course.title}
      ...
      <div className="flex justify-around">
        <button
          ...
          className="px-4 py-2.5 rounded-2xl border shadow-2xl shadow-gray-300 transform transition duration-200 hover:scale-105"
        >
          Learn More
        </button>
        <button className="bg-purple-700 hover:bg-purple-800 text-white px-4 py-2.5 rounded-2xl transform transition duration-200 hover:scale-105">
          Apply Now
        </button>
      </div>
