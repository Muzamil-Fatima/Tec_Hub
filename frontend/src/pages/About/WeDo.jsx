  ...
  const imp = [
    {
      title: "Internships",
      description:
        "Hands-on industry experience with real projects and mentorship.",
      icon: "",
    },
    {
      title: "Hackathons",
      description:
        "Collaborative coding competitions to solve real-world challenges.",
      icon: (
        <svg
          width="32px"
          height="32px"
    ...
    },
    {
      title: "Classes",
      description:
        "Future-ready courses in tech, designed to make you job-ready.",
      icon: "",
    },
  ];
  return (
